...
TypeScript full stack — Hono, tRPC v11 (HTTP, queries/mutations + Server-Sent Events for subscriptions), Drizzle, React 19, Vite 8, Tailwind, shadcn/ui, TanStack Query v5 (server state + real-time subscriptions). E2E encryption (AES-256-GCM). Postgres. Distroless Docker image.
